...
"""
================================================================================
 🏢 IRM — SAP Business One On-Premise Outbound Sync Agent
...
def push_data_to_irm(records):
    ...
    headers = {
        ...
        "User-Agent": "IRM-OnPrem-SAP-Agent/1.0",
    }
...
def main():
    ...
    logger.info("================================================================================")
    logger.info(f"  IRM SAP ON-PREMISE SYNC AGENT STARTED [{datetime.now().strftime('%d/%m/%Y %H:%M:%S')}]")
    logger.info("================================================================================")
    
    try:
        # Step 1: Query from SAP Local SQL
        records = query_sap_data()
        
        # Step 2: Push to IRM Cloud
