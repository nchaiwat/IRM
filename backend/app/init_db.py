    ...
    try:
        async with AsyncSessionLocal() as session:
            items_seed = [
                ...
                ("HW-3008-00000", "พลาสติกใส 50\"x0.05mm.X90Y", "113", 60, 3),
                ("HW-3009-00000", "พลาสติกใส 80\"x0.05mm.X90Y (ขอบยาง)", "113", 60, 3),
                ("HW-3002-00000", "พลาสติกใส 80\"x0.05mm.X90Y", "113", 60, 3),
                ("HW-3002-00000-B", "พลาสติกใส 80\"x0.05mm.X90Y (เสริม)", "113", 60, 3),
            ...
            for icode, desc, grp, lt, na in items_seed:
                ...
                if not (await session.execute(stmt_im)).scalar_one_or_none():
